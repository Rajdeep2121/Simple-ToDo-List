            ...
            <div class="col-md-12">
                <div class="heading">
                    <div class="addTask">
                        ...
                        <form action="delTask.php" method="post">
                            <div class="col-md-4">
                                <h2>Delete Task</h2>
                                <input class="form-control" style="width: 300px;text-align: center;" type="text" name="deltask" placeholder="Enter task"><br>
...
if($records==''){
    ...
    while($row = mysqli_fetch_array($records)){
        echo "<div class='col-md-12' id='containTask'>";
        echo "<p>".$row['text']."</p>";
        // echo "<form action='completed.php' method='POST'> <button type='submit'>Click</button> </form>"
        echo "</div>";
    }
}
?>
